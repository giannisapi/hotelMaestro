...
public abstract class AbstractIntegrationTest {
	...
	public void setUp() {
		...
		DB database = mongo.getDB("hotelMaster");

		// Customers
		
		DBCollection roomTypes = database.getCollection("roomType");
		
		
		DBObject single = new BasicDBObject("name","singleRoom");
		single.put("description", "singleRoome");
		single.put("price", "111");
